...
export default {
  GET_GRAPH_FROM_API({ commit }, graphParams) {
    return axios(
      `http://46.243.227.152:8000/api/v1/calculation/booking-dynamics?flight_number=${graphParams.flight_number}&flight_date=${graphParams.flight_date}&booking_class=${graphParams.booking_class}&booking_period=${graphParams.booking_period}`,
      {
        method: "GET",
      }
    )
